...
if __name__ == "__main__":
    ...
    print(f"compute_baseline: {compute_baseline}")
    ...
    if os.path.exists(fs_results_file_name):
        ...
        print("Computing fs_results via 10-shot Eval")
        set_seed(seed+42)
    ...
    if mean_activations_path is not None and os.path.exists(mean_activations_path):
        ...
        mean_activations = get_mean_head_activations(dataset, model=model, 
            model_config=model_config, tokenizer=tokenizer, n_icl_examples=n_shots,
